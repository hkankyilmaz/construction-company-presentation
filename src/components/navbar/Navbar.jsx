...
function Navbar({ type }) {
  ...
  const [previosScrollPosition, setPreviosScrollPosition] = useState(0);
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      console.log(currentScrollPosition, previosScrollPosition);
      if (
        previosScrollPosition > currentScrollPosition &&
      ...
      setPreviosScrollPosition(currentScrollPosition);
    };
