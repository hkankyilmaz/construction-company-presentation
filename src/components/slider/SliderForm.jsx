  ...
  return (
    <form className="flex flex-col max-md:w-[310px] md:max-w-[600px] lg:absolute bg-white lg:bottom-[20%] lg:right-[7%] xl:right-[18%] space-y-3 md:space-y-5 p-4 md:p-20 rounded-2xl">
      ...
      <p className="text-gray-500 max-md:text-xs">
        Proje hakkında daha fazla bilgi almak ve satın alma &amp; ödeme
        seçenekleri için bizimle iletişime geçebilirsiniz. İgilendiğiniz daire
        tipini seçmeyi unutmayın. Size hemen dönüş yapacağız.
      </p>
      <input
      ...
      <div className="flex items-center">
        ...
        <label className="text-gray-500 ml-2 max-md:text-xs" htmlFor="checkbox">
